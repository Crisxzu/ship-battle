...
public final class SetupPlayerShipView extends GuiView<SetupMenuController> {
    ...
    protected void buildUI() {
        ...
        controlsRow.defaults().growX().padRight(6f);
        ...
        controlsRow.add(readyButton).growX();
        ...
        controlsRow.add(resetButton).growX();
        ...
        controlsRow.add(cancelSelectionButton).growX().padRight(0f);

        leftPanel.add(controlsRow)
            .growX()
            .padTop(10f)
            .row();
