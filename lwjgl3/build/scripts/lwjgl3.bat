...
set CLASSPATH=%APP_HOME%\lib\ShipBattle-1.0-SNAPSHOT.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" com.par_28.ship_battle.lwjgl3.Lwjgl3Launcher %*
